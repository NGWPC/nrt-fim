...
class train_dataset(TorchDataset):
    ...
    def __init__(self, cfg: DictConfig):
        ...
        self.runoff = xr.open_dataset(Path("/Users/taddbindas/projects/NGWPC/f1_trainer/data/sample_dir/router.zarr"), engine="zarr", chunked_array_type="cubed")
        self.SOIL_M = xr.open_dataset(Path("/Users/taddbindas/projects/NGWPC/f1_trainer/data/sample_dir/soil_moisture.zarr"), engine="zarr", chunked_array_type="cubed")
        
        self.obs = rioxarray.open_rasterio(Path("/Users/taddbindas/projects/NGWPC/f1_trainer/data/sample_dir/flood_percent_250m.tif"), chunked_array_type="cubed")
        self.flow_acc = rioxarray.open_rasterio(Path("/Users/taddbindas/projects/NGWPC/f1_trainer/data/sample_dir/flow_acc_250m.tif"), chunked_array_type="cubed")
        self.flow_dir = rioxarray.open_rasterio(Path("/Users/taddbindas/projects/NGWPC/f1_trainer/data/sample_dir/flow_dir_250m.tif"), chunked_array_type="cubed")
        self.surface_extent = rioxarray.open_rasterio(Path("/Users/taddbindas/projects/NGWPC/f1_trainer/data/sample_dir/surface_extent_250m.tif"), chunked_array_type="cubed")
